...
class User extends MY_Controller
{
	...
	public function profile()
	{
		...
		$this->render('Perfil', 'user/profile', $data);
	}
	...
	{
		$data[] = '';
		$this->render('Cambiar Contraseña', 'user/change_password', $data);
	}
	...
	public function profile_update()
	{
		$username = $this->Session->getLoggedDetails()['username'];
		$data['user_details'] = $this->Users->getUserBy(array('username' => $username));
		$this->render('Perfil', 'user/profile_update', $data);
	}
	...
	public function list()
	{
		...
		$this->render('Todos los Usuarios', 'user/list', $data);
	}

	public function add_user()
	{
		$this->render('Agregar Usuario', 'user/add_user');
	}
