...
//Root Url of ur site
define('BASE_URL', 'http://159.65.234.243:8080/');

define('PAGE_LOADER', BASE_URL.'assets/img/loading.webp');

//Client Specific site wide information
define('CLIENT_FNAME','Tiket');
define('CLIENT_MNAME','Tiket');
define('CLIENT_FULL_NAME', 'Tiket');
define('CLIENT_ADDRESS','Tiket, Tiket');
