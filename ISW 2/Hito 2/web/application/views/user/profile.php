            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h3 class="h4"> Perfil <i class="fa fa-user"></i></h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-md-12 p-2">
                            <div class="row">
                                <div class="col-md-3  font-weight-bold">Correo</div>
                                <div class="col-md-9"><?= $user_details['email'] ?></div>
                            </div>
                        </div>
                        <div class="col-md-12 p-2">
                            <div class="row">
                                <div class="col-md-3  font-weight-bold">Celular</div>
                                <div class="col-md-9"><?= $user_details['mobile'] ?></div>
                            </div>
                        </div>
                        <div class="col-md-12 p-2">
                            <div class="row">
                                <div class="col-md-3  font-weight-bold">Nombre de Usuario</div>
                        ...
                        <!--<div class="col-md-12 p-2">
                            <div class="row">
                                <div class="col-md-3  font-weight-bold">Ultima Actualizacion</div>
                        ...
                        <div class="col-md-12 p-2">
                            <div class="row p-2 ">
                                <a href="<?= BASE_URL ?>user/change_password" class="btn btn-secondary pull-right mr-3">Cambiar Password</a>
                                <!-- <a href="<?= BASE_URL ?>user/profile_update" class="btn btn-success pull-right">Actualizar Perfil</a> -->
                            </div>
                        </div>
