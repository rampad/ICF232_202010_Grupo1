                ...
                columns: [
                   /* {
                        ...
                        render: function (data) {
                            return '<a href="' + BASE_URL + 'user/profile/' + data + '" style="color: gray; text-decoration:none;">' + data + '</a>'
                        }
                    },*/
                    {
                        title: "Nombre",
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                           ...
                           if(data==80){
                            ...
                            return '<span><div class="badge badge-corner bg-orange">Administrador</div></span>'
                            
                        }
                        if(data==60){
                        
                        
                        return '<span><div class="badge badge-corner bg-green">T&eacute;cnico</div></span>'
                        
                        }
                        if(data==10){
                        return '<span><div class="badge badge-corner bg-blue">Usuario/a</div></span>'
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            return '<span><div class="badge badge-corner bg-green">Activo</div></span>'
