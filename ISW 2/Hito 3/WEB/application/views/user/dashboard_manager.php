                        ...
                        <div class="tab-pane fade show active p-3" id="one" role="tabpanel"
                            ...
                            if (is_array($recent['created']) && count($recent['created']) > 0) {
                                ...
                                <div class="item d-flex  justify-content-between">
                                    ...
                                    <p>Proposito: ' . $recent_created['purpose'] . '</p>
                                    <p>Asunto: ' . $recent_created['subject'] . '</p>
                                    </div>
                                    </div>
                        ...
                        <div class="tab-pane fade p-3" id="two" role="tabpanel" aria-labelledby="two-tab">
                            ...
                            if (is_array($recent['open']) && count($recent['open']) > 0) {
                                ...
                                <div class="info d-flex">
                                    ...
                                    <p>Proposito: ' . $recent_open['purpose'] . '</p>
                                    <p>Asunto: ' . $recent_open['subject'] . '</p>
                                    </div>
                                    </div>
                        ...
                        <div class="tab-pane fade p-3" id="three" role="tabpanel" aria-labelledby="three-tab">
                            ...
                            if (is_array($recent['assigned']) && count($recent['assigned']) > 0) {
                                ...
                                <div class="info d-flex">
                                    ...
                                    <p>Proposito: ' . $recent_assigned['purpose'] . '</p>
                                    <p>Asunto: ' . $recent_assigned['subject'] . '</p>
                                    </div>
                                    </div>
                        ...
                        <div class="tab-pane fade p-3" id="four" role="tabpanel" aria-labelledby="four-tab">
                            ...
                            if (is_array($recent['closed']) && count($recent['closed']) > 0) {
                                ...
                                <div class="info d-flex">
                                    ...
                                    <p>Proposito: ' . $recent_closed['purpose'] . '</p>
                                    <p>Asunto: ' . $recent_closed['subject'] . '</p>
                                    </div>
                                    </div>
...
<script>
    ...
    var barChartExample = new Chart(BARCHARTEXMPLE, {
        ...
        data: {
            labels: ["Abierto", "Asignado", "Cerrado"],
            datasets: [
                {
                    label: "Severity High",
                    backgroundColor: [
