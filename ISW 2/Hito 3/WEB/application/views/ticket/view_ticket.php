                ...
                <div class="col-md-12">
                    <div class="card ticket-head custom-border-radius m-0">
                        <div class="d-flex align-content-between">
                            ...
                            if ($info['status']==50){
                              print '<span class="badge badge-corner bg-yellow">En Progreso</span>';
                              }
                              
                            if ($info['status']==0){
                            print '<span class="badge badge-corner bg-green">Abirerto</span>';
                            }
                            
                           if($info['status']== 100){
                           print '<span class="badge badge-corner bg-red">Cerrado</span>';
                           }
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-primary" id="reply"
                                            data-ticket-no="<?= $info['ticket_no'] ?>">Responder <i class="fa fa-reply"></i>
                                    </button>
                                </div>
                            </div>
        ...
        <div class="col-md-4 no-padding-left ticket-details-right">
            <div class="card custom-border-radius sticky-this">
                <div class="card-header d-flex align-items-center custom-border-radius">
                    <h3 class="h4"><i class="fa fa-ticket"></i>Detalles</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 table-responsiveW">
                           ...
                           print '<span class="badge badge-corner bg-red">Cerrado</span>';
                            ...
                            ?>
                                    ...
                                    <td><a href="Javascript:void(0);" class="edit-ticket-dropdown">Editar</a>
                        ...
                        print '<span><div class="badge badge-corner bg-green">Baja</div></span>';
                        
                        }
                        
                        if ($info['severity'] == 10){
                        
                        print '<span><div class="badge badge-corner bg-red">Alta</div></span>';                        }
                        
                        if ($info['severity'] == 5){
                        
                          print '<span><div class="badge badge-corner bg-yellow">Media</div></span>';
...
<script>
    $(document).ready(function () {
        ...
        $('select.form-control').on('change', function () {
            ...
            if (field === "assign_to") {
                message = data['meta']['message'] = 'Cambio la asigancion a <span class="user-label" data-username="' + value + '"></span>';
